        ...
        <footer className="bg-gray-800 text-white">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {/* Company Info */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4">GatiyanFood</h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/delivery/register" className="text-gray-300 hover:text-white">
                                    Become Delivery Partner
                                </Link>
                            </li>
                            <li>
                                <Link to="/partner/login" className="text-gray-300 hover:text-white">
                                    Partner Login
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="mt-8 pt-8 border-t border-gray-700">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-300 text-sm">
                            © {new Date().getFullYear()} GatiyanFood. All rights reserved.
                        </p>
